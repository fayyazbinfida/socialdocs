...
<!-- Mirrored from docs.uchat.com.au/integration/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2023 09:42:33 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Integrations | Help Center</title>
    <meta name="generator" content="VuePress 1.8.0">
    <link rel="icon" href="<?php echo $_SESSION['PATH'];?>/logo.png">
    <link rel="manifest" href="<?php echo $_SESSION['PATH'];?>/manifest.json">
    <link rel="apple-touch-icon" href="<?php echo $_SESSION['PATH'];?>/icons/apple-touch-icon-152x152.png">
    <link rel="mask-icon" href="<?php echo $_SESSION['PATH'];?>/icons/safari-pinned-tab.svg" color="#3eaf7c">
    <meta name="description" content="Explore the articles below or use the search bar">
    <meta name="theme-color" content="#3eaf7c">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="msapplication-TileImage" content="<?php echo $_SESSION['PATH'];?>/icons/msapplication-icon-144x144.png">
    ...
    <link rel="preload" href="<?php echo $_SESSION['PATH'];?>/assets/js/139.a4b8bb27.js" as="script">
    ...
    <link rel="prefetch" href="<?php echo $_SESSION['PATH'];?>/assets/js/121.d11d34d8.js">
    ...
    <div id="app" data-server-rendered="true">
        <div class="theme-container">
            <header class="navbar">
                ...
                <a href="<?php echo $_SESSION['PATH'];?>/index.php" class="home-link router-link-active">
                    <img src="<?php echo $_SESSION['PATH'];?>/logo.png" alt="Help Center" class="logo">
              ...
              <div class="dropdown-wrapper"><button type="button" aria-label="Channels" class="dropdown-title"><span
                ...
                <ul class="nav-dropdown" style="display:none;">
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#omni-bot" class="nav-link">
                      Omnichannel
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#facebook-bot" class="nav-link">
                      Facebook
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#instagram-bot" class="nav-link">
                      Instagram
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#telegram-bot" class="nav-link">
                      Telegram
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#slack-bot" class="nav-link">
                      Slack
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#wechat-bot" class="nav-link">
                      WeChat
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#whatsapp-360dialog-sandbox"
                      class="nav-link">
                      WhatsApp Sandbox
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/whatsapp-api.php" class="nav-link">
                      WhatsApp
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/cloudapi.php" class="nav-link">
                      WhatsApp Cloud API
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#whatsapp-sms-voice-bot"
                      class="nav-link">
                      SMS
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#whatsapp-sms-voice-bot"
                  ...
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#google-my-business"
                      class="nav-link">
                      Google
                    </a></li>
                  ...
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/guide/setup-create.php#vk-bot" class="nav-link">
                      Vk
                    </a></li>
                </ul>
              </div>
            </div>
            <div class="nav-item"><a href="<?php echo $_SESSION['PATH'];?>/flow-builder/index.php" class="nav-link">
                Flow Builder
              </a></div>
            <div class="nav-item">
              <div class="dropdown-wrapper"><button type="button" aria-label="Integration" class="dropdown-title"><span
                ...
                <ul class="nav-dropdown" style="display:none;">
                  <li class="dropdown-item"><a href="index.php" aria-current="page"
            ...
            <div class="nav-item"><a href="<?php echo $_SESSION['PATH'];?>/ecommerce/index.php" class="nav-link">
                Ecommerce
              </a></div>
            ...
            <!-- <div class="nav-item">
              <div class="dropdown-wrapper"><button type="button" aria-label="For Developers"
                ...
                <ul class="nav-dropdown" style="display:none;">
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/for-developers/index.php" class="nav-link">
                      Dynamic Content
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/for-developers/API/index.php" class="nav-link">
                      API
                    </a></li>
                  <li class="dropdown-item"><a href="<?php echo $_SESSION['PATH'];?>/for-developers/my-apps/index.php" class="nav-link">
                      Mini-App
                    </a></li>
                </ul>
              </div>
            </div>
            <div class="nav-item"><a href="<?php echo $_SESSION['PATH'];?>/partner/about.php" class="nav-link">
                Partner
              </a></div>
