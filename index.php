...
<main class="page">
  <div class="theme-default-content content__default">
    <h1 id="start">
      <a href="#start" class="header-anchor">#</a>
      Connecting Social Media Accounts in Smart Social: A Step-by-Step Guide
    </h1>
    <p>
      Are you ready to supercharge your social media presence with Smart Social? Great! We've put together a simple guide to help you seamlessly connect your social media accounts and unlock the full potential of our platform. Follow these easy steps:
    </p>
    <h1 id="step01">
      <a href="#step01" class="header-anchor">#</a>
      Step 1: Log into Your Smart Social Account
    </h1>
    <p>
    ...
    <p>
      Once the login is successful, you'll receive a confirmation that your social media account is now connected. Congratulations! You're now ready to explore the full range of features Smart Social has to offer.
    </p>
    <h1 id="step06">
      <a href="#step06" class="header-anchor">#</a>
      Step 6: Explore "Manage Accounts" for Further Control
    </h1>
    <p>
    ...
    <p>
      ...
      If you encounter any issues during the process, don't hesitate to reach out to our support team for assistance. Happy connecting!
    </p>
  </div>
