...
<!-- Mirrored from docs.Smart ChatBot.com.au/flow-builder/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Dec 2023 09:42:25 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <title>Flow Builder Overview | Help Center</title>
  ...
  <link rel="preload" href="<?php echo $_SESSION['PATH'];?>/assets/js/11.6f5fb873.js" as="script">
            ...
            <header class="navbar">
                ...
                <div class="links">
                    ...
                    <nav class="nav-links can-hide">
                        <div class="nav-item">
                            <a href="<?php echo $_SESSION['PATH'];?>/guide/index.php" class="nav-link">
                                Guide
                            </a>
                        </div>
                        <div class="nav-item">
                        ...
                        <div class="nav-item">
                            <a href="index.php" aria-current="page" class="nav-link router-link-exact-active router-link-active">Flow Builder</a>
                        </div>
                        <div class="nav-item">
                            <div class="dropdown-wrapper">
                        ...
                        <!-- <div class="nav-item">
                            <div class="dropdown-wrapper">
                                ...
                                <ul class="nav-dropdown" style="display:none;">
                                    <li class="dropdown-item">
                                        <a href="<?php echo $_SESSION['PATH'];?>/for-developers/index.php" class="nav-link">
                                            Dynamic Content
                                        </a>
                                    </li>
                                    <li class="dropdown-item">
                        ...
                        <div class="nav-item">
                            <a href="https://www.brixbull.ai/" target="_blank" rel="noopener noreferrer" class="nav-link external">
                                Smart ChatBot Home
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound">
                                        <path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path>
